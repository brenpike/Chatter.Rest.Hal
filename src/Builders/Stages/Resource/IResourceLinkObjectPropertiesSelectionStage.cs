...
public interface IResourceLinkObjectPropertiesSelectionStage : IResourceLinkCreationStage, IResourceCuriesLinkCreationStage, IAddLinkToResourceStage, IAddSelfLinkToResourceStage, IAddCuriesLinkToResourceStage, IAddEmbeddedResourceToResourceStage, IBuildHal
{
	...
	/// <summary>
	/// Sets the media type hint of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
	...
	/// <summary>
	/// Sets the depreciation URL of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
	...
	/// <summary>
	/// Sets the name of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
	...
	/// <summary>
	/// Sets the profile URI of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
	...
	/// <summary>
	/// Sets the title of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
	...
	/// <summary>
	/// Sets the hreflang of the <see cref="IResourceLinkObjectPropertiesSelectionStage"/>
	/// </summary>
